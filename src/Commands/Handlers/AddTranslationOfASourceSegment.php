...
class AddTranslationOfASourceSegment extends CommandHandler {
    protected $rules = [
            'sessionId'           => [
                    'required' => true,
    ...
    public function handle( $params = [] ) {
        $response = $this->httpClient->request( Constants::HTTP_VERBS_CREATE, $this->buildUri(
                'project/child/{projectId}/file/{fileId}/targetLang/{targetLangCode}/sourceSegment/{sourceSegmentId}/translation',
                [
