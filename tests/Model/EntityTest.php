...
class EntityTest extends BaseTest
{
    ...
    public function create_the_master_project_model()
    {
        ...
        $segmTrans1       = new TranslatedSegment($childTranslation, $file, 22, 5, 'en-US', $this->getSourceSegments($file)[ 0 ], 'blah', 'blah blah blah');
        $segmTrans2       = new TranslatedSegment($childTranslation, $file, 22, 5, 'en-US', $this->getSourceSegments($file)[ 1 ], 'blah', 'blah blah blah');
        $segmTrans3       = new TranslatedSegment($childTranslation, $file, 22, 5, 'en-US', $this->getSourceSegments($file)[ 2 ], 'blah', 'blah blah blah');

        try {
            new TranslatedSegment($childTranslation, $file, 22, 4343, 'en-US', $this->getSourceSegments($file)[ 2 ], 'blah', 'blah blah blah');
        } catch (\DomainException $e) {
